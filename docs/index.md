...
*   [**Usage Guide**](usage.md) - Learn how to optimize queries and use Chat Mode.
*   [**Setup & Troubleshooting**](troubleshooting.md) - How to connect Ollama or Cloud APIs and fix common issues.
*   [**Best Practices**](../README.md#best-practices-for-context--tuning) - Tips for getting the best results from AI.
