...
![Logo](assets/icon_64.png) QueryTune is a cross-platform application (macOS, Windows, Linux) designed to optimize SQL queries using Large Language Models (LLMs). 
